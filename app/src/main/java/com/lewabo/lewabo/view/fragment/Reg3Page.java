...
import com.lewabo.lewabo.databinding.FragmentReg3PageBinding;
import com.lewabo.lewabo.utility.Utility;
import com.lewabo.lewabo.view.activity.LoginPage;

public class Reg3Page extends Fragment {
    Utility utility;
    Context context;
    FragmentReg3PageBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (binding == null) {
            binding = FragmentReg3PageBinding.inflate(inflater, container, false);
            try {
                context = getActivity();
                ...
                if (getArguments() != null && getArguments().containsKey("email")) {
                    ...
                    if (!TextUtils.isEmpty(email)) {
                        binding.reg3Continue.setOnClickListener(new View.OnClickListener() {
                            @Override
                ...
                binding.reg3Privacy.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        try {
                ...
                binding.reg3Login.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
